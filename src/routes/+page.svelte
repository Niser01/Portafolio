  ...
  <div class="w-full flex flex-col md:flex-row h-full relative z-10 max-w-7xl">
    <div class="text-white md:w-1/2 flex flex-col justify-center h-full space-y-4">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <h1 class="text-[48px] font-extrabold leading-tight bg-gradient-to-r from-[#33AAFF] to-[#D711FF] bg-clip-text text-transparent">Desarrollador de Software</h1>
      </div>
    </div>

    <div class="md:w-1/2 h-full flex items-center justify-center relative">
      <div class="w-120 h-120 bg-white rounded-full shadow-lg absolute z-0"></div>
      <img src="/imagen_banner.png" alt="Mockup computador" class="w-200 h-200 object-contain relative z-10 opacity-0 translate-y-4 animate-fadeInUp"/>
...
<section id="sobremi" class="h-screen flex items-center justify-center bg-white">
